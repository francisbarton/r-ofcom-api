#' Ofcom API Key
#'
#' @description Assign or reassign API key for the Ofcom API.
#'
#' @details By default, this package will look for the environment variable
#'   `OFCOM_API_KEY` when the package is loaded. If found, the API key will
